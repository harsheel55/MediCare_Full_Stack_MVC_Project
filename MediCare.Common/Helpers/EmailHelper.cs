...
namespace MediCare_MVC_Project.MediCare.Common.Helpers
{
    public class EmailHelper : IEmailHelper
    {
        ...
        //                        <p style='font-size: 16px;'><strong>Start Date &amp;Time:</strong> {appointment.AppointmentStarts.ToString("f")}</p>
        //                        <p style='font-size: 16px;'><strong>End Date &amp;Time:</strong> {appointment.AppointmentEnds.ToString("f")}</p>
